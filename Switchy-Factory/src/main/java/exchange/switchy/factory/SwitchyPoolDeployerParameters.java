...
public class SwitchyPoolDeployerParameters {
    ...
    public static void writeObject(ObjectWriter w, SwitchyPoolDeployerParameters obj) {
        w.write(obj.factory);
        w.write(obj.token0);
        w.write(obj.token1);
        w.write(obj.fee);
    ...
    public static SwitchyPoolDeployerParameters readObject(ObjectReader r) {
        return new SwitchyPoolDeployerParameters(
