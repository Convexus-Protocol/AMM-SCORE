...
public class MintIcxTest extends NonFungiblePositionManagerTest {
  ...
  void failsIfCannotTransfer () {
    ConvexusPoolInitializerUtils.createAndInitializePoolIfNecessary(ConvexusPoolMock.class, alice, factory, ICX.getAddress(), usdc.getAddress(), FEE_AMOUNTS[MEDIUM], encodePriceSqrt(ONE, ONE), tickSpacing);
  ...
  void createsAToken () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, nft, fifteen);
