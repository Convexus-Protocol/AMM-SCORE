...
public class ExactInputTest extends SwapRouterTest {
  ...
  void testSinglePool01 () {
    ...
    exactInput(sicx.score, usdc.score);
  ...
  void testSinglePool10 () {
    ...
    exactInput(usdc.score, sicx.score);
  ...
  void testMultiplePool012 () {
    ...
    exactInput(sicx.score, usdc.score, baln.score, BigInteger.valueOf(5), BigInteger.ONE);
  ...
  void testMultiplePool210 () {
    ...
    exactInput(baln.score, usdc.score, sicx.score, BigInteger.valueOf(5), BigInteger.ONE);
