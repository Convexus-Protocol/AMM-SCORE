...
import exchange.convexus.positionmgr.IncreaseLiquidityParams;
import exchange.convexus.positionmgr.IncreaseLiquidityResult;
...
public class NonFungiblePositionManager extends IRC721Enumerable {
    ...
    @EventLog
    public void DecreaseLiquidity(BigInteger tokenId, BigInteger liquidity, BigInteger amount0, BigInteger amount1) {}
    ...
    @EventLog
    public void Collect(BigInteger tokenId, Address recipient, BigInteger amount0Collect, BigInteger amount1Collect) {}
