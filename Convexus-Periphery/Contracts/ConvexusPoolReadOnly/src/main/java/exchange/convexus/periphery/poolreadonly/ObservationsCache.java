...
class ObservationsDB extends DictDBCache<Integer, Oracle.Observation> {

  public ObservationsDB(Address target) {
    super(target);
  }

  @Override
  public Observation getExternal(Integer key) {
    return IConvexusPool.observations(target, key);
  }
}

public class ObservationsCache {
  // ================================================
  // Consts
  // ================================================
  // Contract class name
  ...
  private final ObservationsDB observations;

  public ObservationsCache (Address pool) {
    this.observations = new ObservationsDB(pool);
  }
