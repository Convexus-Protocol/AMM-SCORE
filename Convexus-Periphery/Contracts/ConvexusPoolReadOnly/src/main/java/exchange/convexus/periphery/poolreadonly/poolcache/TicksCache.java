...
class TicksDB extends DictDBCache<Integer, Tick.Info> {

  public TicksDB(Address target) {
    super(target);
  }

  @Override
  public Info getExternal(Integer key) {
    return IConvexusPool.ticks(target, key);
  }
}

public class TicksCache {
  // ================================================
  // Consts
  // ================================================
  ...
  private final TicksDB ticks;

  public TicksCache (Address pool) {
    this.ticks = new TicksDB(pool);
  }
