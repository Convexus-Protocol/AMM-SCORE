...
import exchange.convexus.staker.Deposit;
import exchange.convexus.staker.Incentive;
import exchange.convexus.staker.IncentiveKey;
 ...
 */
public class ConvexusStaker implements IRC721Receiver {
    ...
    @EventLog
    public void DepositTransferred(
        BigInteger tokenId, 
        Address oldOwner, 
        Address newOwner) {}
    ...
    @EventLog
    public void TokenUnstaked(BigInteger tokenId, byte[] incentiveId) {}

    /// @notice Event emitted when a reward token has been claimed
    /// @param to The address where claimed rewards were sent to
    /// @param reward The amount of reward tokens claimed
    @EventLog
    public void RewardClaimed(Address to, BigInteger reward) {}
    ...
    /// @param incentiveId The incentive in which the token is staking
    @EventLog
    public void TokenStaked(BigInteger tokenId, byte[] incentiveId, BigInteger liquidity) {}
