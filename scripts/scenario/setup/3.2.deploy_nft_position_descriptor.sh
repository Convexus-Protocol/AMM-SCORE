...
# Start
deployName="Convexus NFT Position Descriptor"
info "Setting up ${deployName}..."

# Package information
pkg=$(getNonfungibleTokenPositionDescriptorPkg)
javaPkg=":Convexus-Periphery:Contracts:NonfungibleTokenPositionDescriptor"
build="optimized"
