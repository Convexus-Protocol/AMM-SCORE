             ...
             ITicks
{
   ...
   * See {@code ConvexusPool1Factored} constructor for the actual pool deployed on the network
   */
  protected ConvexusPool1 (Parameters parameters) {
    // Initialize settings
