...
package exchange.convexus.test.contracts.pool;
...
public class Pool2 extends ConvexusPool2 {
    public Pool2(Address token0, Address token1, Address factory, int fee, int tickSpacing) {
             ...
             ITicks
{
   ...
   * See {@code ConvexusPool2Factored} constructor for the actual pool deployed on the network
   */
