...
public class FlashWithLiquidityTest extends ConvexusPoolTest {
  ...
  void testTransfersTheAmount0ToTheRecipient () {
    ...
    verify(sicx.spy).Transfer(pool.getAddress(), bob.getAddress(), new BigInteger("100"), "{\"method\": \"deposit\"}".getBytes());
  }
  ...
  void testTransfersTheAmount1ToTheRecipient () {
    ...
    reset(usdc.spy);
    flash(alice, "100", "200", bob, "101", "201");
    verify(usdc.spy).Transfer(pool.getAddress(), bob.getAddress(), new BigInteger("200"), "{\"method\": \"deposit\"}".getBytes());
  }
  ...
  void testCanFlashOnlyToken0 () {
    ...
    verify(sicx.spy).Transfer(pool.getAddress(), bob.getAddress(), new BigInteger("101"), "{\"method\": \"deposit\"}".getBytes());
  ...
  void testCanFlashOnlyToken1 () {
    ...
    verify(usdc.spy).Transfer(pool.getAddress(), bob.getAddress(), new BigInteger("102"), "{\"method\": \"deposit\"}".getBytes());
  ...
  void testCanFlashEntireTokenBalance () {
    ...
    verify(sicx.spy).Transfer(pool.getAddress(), bob.getAddress(), balance0, "{\"method\": \"deposit\"}".getBytes());
    verify(usdc.spy).Transfer(pool.getAddress(), bob.getAddress(), balance1, "{\"method\": \"deposit\"}".getBytes());
  }
