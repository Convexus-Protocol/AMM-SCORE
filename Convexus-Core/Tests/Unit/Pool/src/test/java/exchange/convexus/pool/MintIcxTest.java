...
public class MintIcxTest extends ConvexusPoolTest {
  ...
  void setup() throws Exception {
    ...
    reset(factory.spy);
    setup_tokens();
    setup_pool_icx(factory.getAddress(), FEE, tickSpacing);
    reset(pool.spy);

    alice.addBalance("ICX", BigInteger.valueOf(1000000000));

    ConvexusFactoryUtils.createPool(factory, alice, ICX.getAddress(), usdc.getAddress(), FEE, pool.getAddress());
  ...
  BigInteger initializeWithPrice10_1() {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, BigInteger.valueOf(9996));
  ...
  void testAmountExceedsTheMax () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("36384355944659449090771081304852070"));
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("3638435594465944908512579814181605"));
  ...
  void testTotalAmountAtTickExceedsMax () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("3163"));
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("317"));
  ...
  void testTotalAmountAtTickExceedsMax4 () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("36384355944659449090771081304848907"));
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("3638435594465944908512579814181288"));
  ...
  void testToken0Only () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("21549"));
    ...
    assertEquals(BigInteger.valueOf(9996 + 21549), pool.getAccount().getBalance());
    assertEquals(BigInteger.valueOf(1000), usdc.call("balanceOf", pool.getAddress()));
  }
  ...
  void testMaxTickWithMaxLeverage () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("828011525"));

    callee.invoke(alice, "mint", pool.getAddress(), alice.getAddress(), maxTick - tickSpacing, maxTick, TWO.pow(102));

    assertEquals(BigInteger.valueOf(9996 + 828011525), pool.getAccount().getBalance());
    assertEquals(BigInteger.valueOf(1000), usdc.call("balanceOf", pool.getAddress()));
  }
  ...
  void testForMaxTick () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("31549"));
    ...
    assertEquals(BigInteger.valueOf(9996 + 31549), pool.getAccount().getBalance());
    assertEquals(BigInteger.valueOf(1000), usdc.call("balanceOf", pool.getAddress()));
  }
  ...
  void testRemovingWorks () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("121"));
  ...
  void testAddLiquidityToLiquidityGross () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("2"));
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("3"));
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("1"));
  ...
  void testTransfersCurrentPriceOfBothTokens () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("317"));
  ...
  void testWorksForMinMaxTick () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("31623"));
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("3163"));
  ...
  void testTransfersToken1Only () {
    ...
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("2162"));
  ...
  void testMinTickWithMaxLeverage () {
    ...
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("828011520"));
  ...
  void testWorksForMinTickBelowCurrentPrice () {
    ...
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("3161"));
  ...
  void testRemovingWorksBelowCurrentPrice () {
    ...
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("4"));
  ...
  void testProtocolAccumulateDuringSwap () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("3162277660168379332"));
    ConvexusLiquidityUtils.deposit(alice, callee.getAddress(), usdc.score, new BigInteger("316227766016837934"));
    callee.invoke(alice, "mint", pool.getAddress(), alice.getAddress(), minTick + tickSpacing, maxTick - tickSpacing, TEN.pow(18));

    swapExact0For1Icx(TEN.pow(18).divide(TEN), alice);
  ...
  void testPokeNotAllowedOnUnitializedPosition () {
    ...
    ConvexusLiquidityUtils.depositIcx(bob, callee, new BigInteger("3162277660168379332"));
    ConvexusLiquidityUtils.deposit(bob, callee.getAddress(), usdc.score, new BigInteger("316227766016837934"));
  ...
  void testPokeNotAllowedOnUnitializedPosition2 () {
    ...
    ConvexusLiquidityUtils.depositIcx(alice, callee, new BigInteger("4"));
